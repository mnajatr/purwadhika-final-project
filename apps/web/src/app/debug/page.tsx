  ...
  const testAPIConnection = async () => {
    try {
      ...
      const countsResponse = await fetch(
        "http://localhost:8000/api/orders/counts",
        {
          headers: {
            "x-dev-user-id": "4",
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="mb-4 p-4 bg-green-100 rounded">
        ...
        <p className="text-lg">
          Total API calls made: <strong>{callCount}</strong>
        </p>
      </div>
      ...
      <div className="mt-4 p-4 bg-blue-100 rounded">
        ...
        <ul className="list-disc ml-4">
          <li>
            🚀 <strong>Faster filtering</strong> - no network delay
          </li>
          <li>
            💾 <strong>Reduced server load</strong> - 1 API call vs many
          </li>
          <li>
            🔋 <strong>Better UX</strong> - instant response to user actions
          </li>
          <li>
            📱 <strong>Mobile friendly</strong> - less data usage
          </li>
        </ul>
      </div>
    </div>
