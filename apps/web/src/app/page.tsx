      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Fresh groceries delivered to your doorstep. Browse our wide selection of quality products and enjoy convenient shopping.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600">Quick and reliable delivery to your doorstep within hours.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600">Hand-picked fresh products from trusted suppliers.</p>
          </div>
