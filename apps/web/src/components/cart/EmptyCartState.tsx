  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 text-primary/20 text-2xl">
          ⭐
        </div>
        <div className="absolute top-1/3 right-1/3 text-primary/15 text-lg">
          ✨
        </div>
        <div className="absolute bottom-1/4 left-1/3 text-primary/25 text-xl">
          🌟
        </div>
        <div className="absolute bottom-1/3 right-1/4 text-primary/10 text-sm">
          ⭐
        </div>
        <div className="absolute top-1/5 right-1/5 text-primary/20 text-base">
          ✨
        </div>
      </div>
    </div>
